"""
Module to implement the Nash DQN algorithm in RLlib
as described in 
    Ding, Zihan, et al. "A Deep Reinforcement Learning Approach 
    for Finding Non-Exploitable Strategies in Two-Player Atari Games." 
...
class NashDQNConfig(AlgorithmConfig):
    """Defines a configuration class from which a NashDQN Algorithm can be built.
